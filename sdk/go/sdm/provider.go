...
func NewProvider(ctx *pulumi.Context,
	...
	if args.ApiSecretKey != nil {
		args.ApiSecretKey = pulumi.ToSecret(args.ApiSecretKey).(pulumi.StringPtrInput)
	}
...
func (r *Provider) TerraformConfig(ctx *pulumi.Context) (ProviderTerraformConfigResultOutput, error) {
	out, err := ctx.Call("pulumi:providers:sdm/terraformConfig", nil, ProviderTerraformConfigResultOutput{}, r)
	if err != nil {
