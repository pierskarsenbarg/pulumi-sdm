...
type Policy struct {
	...
	PolicyContent pulumi.StringPtrOutput `pulumi:"policyContent"`
}
...
func NewPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.RegisterResource("sdm:index/policy:Policy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.ReadResource("sdm:index/policy:Policy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The content of the Policy, in Cedar policy language.
func (o PolicyOutput) PolicyContent() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Policy) pulumi.StringPtrOutput { return v.PolicyContent }).(pulumi.StringPtrOutput)
}
