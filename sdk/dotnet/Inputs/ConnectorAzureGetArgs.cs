...
namespace PiersKarsenbarg.Sdm.Inputs
{
    ...
    public sealed class ConnectorAzureGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("excludeTags")]
        private InputList<Inputs.ConnectorAzureExcludeTagGetArgs>? _excludeTags;
        ...
        /// </summary>
        public InputList<Inputs.ConnectorAzureExcludeTagGetArgs> ExcludeTags
        {
            get => _excludeTags ?? (_excludeTags = new InputList<Inputs.ConnectorAzureExcludeTagGetArgs>());
            set => _excludeTags = value;
        }

        [Input("includeTags")]
        private InputList<Inputs.ConnectorAzureIncludeTagGetArgs>? _includeTags;
        ...
        /// </summary>
        public InputList<Inputs.ConnectorAzureIncludeTagGetArgs> IncludeTags
        {
            get => _includeTags ?? (_includeTags = new InputList<Inputs.ConnectorAzureIncludeTagGetArgs>());
        ...
        public ConnectorAzureGetArgs()
        {
        }
        public static new ConnectorAzureGetArgs Empty => new ConnectorAzureGetArgs();
    }
}
