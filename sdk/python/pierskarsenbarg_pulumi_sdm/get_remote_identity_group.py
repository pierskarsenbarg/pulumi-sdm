...
def get_remote_identity_group(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Unique identifier of the RemoteIdentityGroup.
    :param builtins.str name: Unique human-readable name of the RemoteIdentityGroup.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_remote_identity_group_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
