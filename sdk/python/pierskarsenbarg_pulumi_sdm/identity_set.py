...
__all__ = ['IdentitySetArgs', 'IdentitySet']

@pulumi.input_type
class IdentitySetArgs:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IdentitySet resource.
        :param pulumi.Input[builtins.str] name: Unique human-readable name of the IdentitySet.
        """
        if name is not None:
...
class IdentitySet(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IdentitySetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IdentitySetArgs.__new__(IdentitySetArgs)

            __props__.__dict__["name"] = name
        super(IdentitySet, __self__).__init__(
            'sdm:index/identitySet:IdentitySet',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'IdentitySet':
        """
        ...
        __props__ = _IdentitySetState.__new__(_IdentitySetState)

        __props__.__dict__["name"] = name
        return IdentitySet(resource_name, opts=opts, __props__=__props__)
