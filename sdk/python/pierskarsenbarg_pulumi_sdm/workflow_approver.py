...
class WorkflowApproverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] workflow_id: The workflow id.
...
@pulumi.type_token("sdm:index/workflowApprover:WorkflowApprover")
class WorkflowApprover(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            account_id: Optional[pulumi.Input[builtins.str]] = None,
            role_id: Optional[pulumi.Input[builtins.str]] = None,
            workflow_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkflowApprover':
        """
