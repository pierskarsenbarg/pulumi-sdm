...
def get_peering_group(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Unique identifier of the PeeringGroup.
    :param builtins.str name: Unique human-readable name of the PeeringGroup.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_peering_group_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
