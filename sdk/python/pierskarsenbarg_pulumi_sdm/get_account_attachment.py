...
def get_account_attachment(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: The id of the account of this AccountAttachment.
    :param builtins.str id: Unique identifier of the AccountAttachment.
    :param builtins.str role_id: The id of the attached role of this AccountAttachment.
    """
    __args__ = dict()
...
def get_account_attachment_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
