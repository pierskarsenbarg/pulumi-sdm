...
class WorkflowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] approval_flow_id: Optional approval flow ID identifies an approval flow that linked to the workflow
        :param pulumi.Input[_builtins.bool] auto_grant: Optional auto grant setting to automatically approve requests or not, defaults to false.
        :param pulumi.Input[_builtins.str] description: Optional description of the Workflow.
        :param pulumi.Input[_builtins.bool] enabled: Optional enabled state for workflow. This setting may be overridden by the system if the workflow doesn't meet the requirements to be enabled or if other conditions prevent enabling the workflow. The requirements to enable a workflow are that the workflow must be either set up for with auto grant enabled or have one or more WorkflowApprovers created for the workflow.
        :param pulumi.Input[_builtins.str] name: Unique human-readable name of the Workflow.
        :param pulumi.Input[_builtins.int] weight: Optional weight for workflow to specify it's priority in matching a request.
        """
...
class Workflow(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="accessRequestFixedDuration")
    def access_request_fixed_duration(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Fixed Duration of access requests bound to this workflow. If fixed duration is provided, max duration must be empty. If neither max nor fixed duration are provided, requests that bind to this workflow will use the organization-level settings.
        """
        return pulumi.get(self, "access_request_fixed_duration")
    ...
    @_builtins.property
    @pulumi.getter(name="accessRequestMaxDuration")
    def access_request_max_duration(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Maximum Duration of access requests bound to this workflow. If max duration is provided, fixed duration must be empty. If neither max nor fixed duration are provided, requests that bind to this workflow will use the organization-level settings.
        """
        return pulumi.get(self, "access_request_max_duration")
    ...
    @_builtins.property
    @pulumi.getter(name="accessRules")
    def access_rules(self) -> pulumi.Output[_builtins.str]:
        """
        AccessRules is a list of access rules defining the resources this Workflow provides access to.
        """
        return pulumi.get(self, "access_rules")
    ...
    @_builtins.property
    @pulumi.getter(name="approvalFlowId")
    def approval_flow_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Optional approval flow ID identifies an approval flow that linked to the workflow
        """
        return pulumi.get(self, "approval_flow_id")
    ...
    @pulumi.getter(name="autoGrant")
    @_utilities.deprecated("""auto_grant is deprecated, see docs for more info""")
    def auto_grant(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Optional auto grant setting to automatically approve requests or not, defaults to false.
        """
        return pulumi.get(self, "auto_grant")
