...
class PeeringGroupPeerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] group_id: Group ID from which the link will originate.
        :param pulumi.Input[_builtins.str] peers_with_group_id: Peering Group ID to which Group ID will link.
        """
...
class PeeringGroupPeer(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="peersWithGroupId")
    def peers_with_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        Peering Group ID to which Group ID will link.
        """
        return pulumi.get(self, "peers_with_group_id")
