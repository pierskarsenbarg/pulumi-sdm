...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] retry_rate_limit_errors: Whether experienced rate limits should cause the client to sleep instead of erroring out
        """
...
class Provider(pulumi.ProviderResource):
    ...
    @_builtins.property
    @pulumi.getter(name="apiAccessKey")
    def api_access_key(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A GUID identifying the API key used to authenticate with the StrongDM API.
        """
        return pulumi.get(self, "api_access_key")
    ...
    @_builtins.property
    @pulumi.getter(name="apiSecretKey")
    def api_secret_key(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A base64 encoded secret key used to authenticate with the StrongDM API.
        """
        return pulumi.get(self, "api_secret_key")
