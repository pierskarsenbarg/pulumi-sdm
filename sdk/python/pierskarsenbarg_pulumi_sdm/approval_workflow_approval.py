...
__all__ = ['ApprovalWorkflowApprovalArgs', 'ApprovalWorkflowApproval']

@pulumi.input_type
class ApprovalWorkflowApprovalArgs:
...
@pulumi.input_type
class _ApprovalWorkflowApprovalState:
    def __init__(__self__, *,
                 account_id: Optional[pulumi.Input[str]] = None,
...
class ApprovalWorkflowApproval(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        approval_workflow_approver_account_example = sdm.ApprovalWorkflowApproval("approvalWorkflowApproverAccountExample",
            account_id="a-234605",
            approval_flow_id="af-6799234",
            approval_step_id="afs-2956266")
        approval_workflow_approver_role_example = sdm.ApprovalWorkflowApproval("approvalWorkflowApproverRoleExample",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ApprovalWorkflowApprovalArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        ApprovalWorkflowApprover links an approval workflow approver to an ApprovalWorkflowStep
        ## Example Usage
        ...
        :param str resource_name: The name of the resource.
        :param ApprovalWorkflowApprovalArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApprovalWorkflowApprovalArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApprovalWorkflowApprovalArgs.__new__(ApprovalWorkflowApprovalArgs)
        ...
        super(ApprovalWorkflowApproval, __self__).__init__(
            'sdm:index/approvalWorkflowApproval:ApprovalWorkflowApproval',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            approval_flow_id: Optional[pulumi.Input[str]] = None,
            approval_step_id: Optional[pulumi.Input[str]] = None,
            role_id: Optional[pulumi.Input[str]] = None) -> 'ApprovalWorkflowApproval':
        """
        ...
        __props__ = _ApprovalWorkflowApprovalState.__new__(_ApprovalWorkflowApprovalState)

        __props__.__dict__["account_id"] = account_id
        __props__.__dict__["approval_flow_id"] = approval_flow_id
        __props__.__dict__["approval_step_id"] = approval_step_id
        __props__.__dict__["role_id"] = role_id
        return ApprovalWorkflowApproval(resource_name, opts=opts, __props__=__props__)
