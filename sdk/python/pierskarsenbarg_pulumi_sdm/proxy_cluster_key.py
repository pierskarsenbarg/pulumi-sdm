...
class ProxyClusterKeyArgs:
    ...
    def proxy_cluster_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def proxy_cluster_id(self, value: pulumi.Input[_builtins.str]):
...
class ProxyClusterKey(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="proxyClusterId")
    def proxy_cluster_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the proxy cluster which this key authenticates to.
        """
        return pulumi.get(self, "proxy_cluster_id")
