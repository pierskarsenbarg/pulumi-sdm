...
def get_approval_workflow_step(approval_flow_id: Optional[builtins.str] = None,
    ...
    :param builtins.str approval_flow_id: The approval flow id specified the approval workfflow that this step belongs to
    :param builtins.str id: Unique identifier of the ApprovalWorkflowStep.
    """
    __args__ = dict()
...
def get_approval_workflow_step_output(approval_flow_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApprovalWorkflowStepResult]:
    """
    ApprovalWorkflowStep links an approval workflow step to an ApprovalWorkflow
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('sdm:index/getApprovalWorkflowStep:getApprovalWorkflowStep', __args__, opts=opts, typ=GetApprovalWorkflowStepResult)
    return __ret__.apply(lambda __response__: GetApprovalWorkflowStepResult(
