...
class GetApprovalWorkflowApproverResult:
    ...
    def approval_step_id(self) -> Optional[builtins.str]:
        """
...
def get_approval_workflow_approver(account_id: Optional[builtins.str] = None,
                                   approval_flow_id: Optional[builtins.str] = None,
                                   approval_step_id: Optional[builtins.str] = None,
    ...
    :param builtins.str approval_flow_id: The approval flow id specified the approval workflow that this approver belongs to
    :param builtins.str approval_step_id: The approval step id specified the approval flow step that this approver belongs to
    :param builtins.str id: Unique identifier of the ApprovalWorkflowApprover.
...
def get_approval_workflow_approver_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          approval_flow_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          approval_step_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          role_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApprovalWorkflowApproverResult]:
    """
    ApprovalWorkflowApprover links an approval workflow approver to an ApprovalWorkflowStep
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('sdm:index/getApprovalWorkflowApprover:getApprovalWorkflowApprover', __args__, opts=opts, typ=GetApprovalWorkflowApproverResult)
    return __ret__.apply(lambda __response__: GetApprovalWorkflowApproverResult(
        account_id=pulumi.get(__response__, 'account_id'),
        approval_flow_id=pulumi.get(__response__, 'approval_flow_id'),
        approval_step_id=pulumi.get(__response__, 'approval_step_id'),
        approval_workflow_approvers=pulumi.get(__response__, 'approval_workflow_approvers'),
